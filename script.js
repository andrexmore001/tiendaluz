...
const productos = [
  {
    ...
    precio: 25000,
    imagenes: ["https://artessana.com.co/imagenes/prod1.jpg", "https://artessana.com.co/imagenes/prod2.png"],
    categoria: "madre",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    precio: 35000,
    imagenes: ["https://artessana.com.co/imagenes/prod2.png", "https://artessana.com.co/imagenes/prod1.jpg"],
    categoria: "ParaEllas",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    precio: 299,
    imagenes: ["https://artessana.com.co/imagenes/prod1.jpg", "https://artessana.com.co/imagenes/prod1.jpg"],
    categoria: "FechasEspeciales",
  },
  {
    id: 8,
...
function cargarProductos() {
  gridProductos.innerHTML = productos
    .map(
      (producto) => `
        <div class="producto" data-id="${producto.id}" data-categoria="${
        producto.categoria
      }" onclick="abrirModalProducto(${producto.id})"  data-precio="${producto.precio}">
...
function abrirModalProducto(id) {
  ...
  if (producto.tiene3D && producto.imagenes.length > 0) {
    ...
    selectorVistas.innerHTML = producto.imagenes
      .map(
        (img, index) => `
            <img 
                src="${img}" 
    ...
    .map(
      (item) => `
        <div class="item-carrito">
            ...
            <i class="fas fa-trash" onclick="eliminarDelCarrito(${
              item.id
            })"></i>
        </div>
    `
...
document
  .querySelector(".cerrar-modal-carrito")
  .addEventListener("click", () => {
...
function cargarVideosSlider() {
  ...
  if (body.classList.contains("Filters")) {
    // No cargar videos TikTok si estamos en la página con clase Filters
    return;
  }
  ...
  sliderTrack.innerHTML = `
        <blockquote class="tiktok-embed"
                ...
                style="width: 95%; height: auto; aspect-ratio: 9/16; display: block; margin: 0 auto;"
        frameborder="0"
            <section>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const productosFilter = document.querySelectorAll(".producto");
  ...
  function filtrarProductos() {
    ...
    productosFilter.forEach((productoF) => {
        debugger
      const categoria = productoF.dataset.categoria;
      if (seleccionadas.length === 0 || seleccionadas.includes(categoria)) {
        productoF.style.display = "";
      } else {
        productoF.style.display = "none";
      }
    });
  }
...
function actualizarPrecio(valor) {
  document.getElementById("precioValor").innerText = parseInt(valor).toLocaleString();
